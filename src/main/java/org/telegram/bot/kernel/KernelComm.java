...
public class KernelComm implements IKernelComm {
    ...
    public KernelComm(AbsApiState apiState) {
    ...
    private void createApi() {
        ...
        this.api = new TelegramApi(apiState, new AppInfo(BotConstants.API_KEY, "bot", botName, botVersion, LANGUAGE_EN), new ApiCallback() {
