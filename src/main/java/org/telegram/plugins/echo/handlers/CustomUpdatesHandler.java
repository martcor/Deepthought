...
public class CustomUpdatesHandler extends DefaultUpdatesHandler {
    ...
    public void setHandlers(IMessageHandler messageHandler, IUsersHandler usersHandler, IChatsHandler chatsHandler, ITLMessageHandler tlMessageHandler) {
    ...
    public void onTLUpdateShortMessageCustom(TLUpdateShortMessage update) {
        ...
        if (user != null) {
            BotLogger.info(LOGTAG, botConfig.languageCode + ": Received message from: " + update.getUserId());
